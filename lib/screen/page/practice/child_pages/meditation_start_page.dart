...
import 'package:affordable_yoga_252/screen/page/practice/child_pages/meditation_complete_page.dart';
import 'package:flutter/material.dart';

class MeditationStartYogaPage extends StatelessWidget {
  const MeditationStartYogaPage(this.yoga, {super.key});
      ...
      floatingActionButton: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => MeditationCompleteYogaPage(yoga),
            ),
          );
        },
        child: Container(
